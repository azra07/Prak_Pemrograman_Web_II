...
function tampilbuku()
{
    ...
    if(!empty($result)){
        ...
        foreach ($result as $buku) {
            ...
            echo "<td>"."<button class=link_none> <a href = 'formbuku.php?id_buku=".$buku['id_buku']."'>✏️ Edit</a> </button>";
            echo "<button class=link_none><a href='buku.php?id_buku=" . $buku['id_buku'] . "' onclick=\"return confirm('Anda yakin ingin menghapusnya?')\"> 🗑️ Hapus</a> </button></td>";
            echo "</tr>";
        }
        echo "</tbody></table>";
    }
...
function tampilmember()
{
    ...
    if (!empty($result)) {
        ...
        foreach ($result as $member) {
            ...
            echo "<td><button class=link_none><a href = 'formmember.php?id_member=".$member['id_member']."'>✏️ Edit</a></button>";
            echo "<button class=link_none><a href='member.php?id_member=" . $member['id_member'] . "' onclick=\"return confirm('Lanjut Hapus ?')\"> 🗑️ Hapus</a></button></td>";
            echo "</tr>";
        }
        echo "</tbody></table>";
    }
    ...
    if (!empty($result)) {
        foreach ($result as $peminjaman) {
            ...
            echo "<td style='white-space: nowrap;'>
                    <a href='FormPeminjaman.php?id_peminjaman={$peminjaman['id_peminjaman']}' class='btn-custom'>✏️ Edit</a>
                    <a href='Peminjaman.php?id_peminjaman={$peminjaman['id_peminjaman']}' onclick=\"return confirm('Lanjut hapus?')\" class='btn-custom'> 🗑️ Hapus</a>
                  </td>";
            echo "</tr>";
        }
    }
